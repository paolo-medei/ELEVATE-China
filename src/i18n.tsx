...
const DICT = {
  ...
  simpleMovePaddocks: { en: 'Paddocks out of grass', zh: '牧草用尽草场' },
  simpleMoveFoot: { en: 'past their season budget', zh: '已超牧季额度' },
  simpleHidden: { en: '{n} were hidden from the camera — normal', zh: '{n} 头被遮挡未拍到，属正常范围' },
  simpleMissingHerd: {
    en: '{n} cattle missing from the {herd}',
    zh: '{herd} 缺 {n} 头',
  },
  ...
  whereSub: {
    en: 'Colour shows which paddocks still have grass to give',
    zh: '颜色表示各草场牧草余量',
  },
  herdCardsTitle: { en: 'Your herds', zh: '各牛群' },
  grassTableTitle: { en: 'Grass in each paddock', zh: '各草场牧草情况' },
  grassLeft: { en: 'Grass left', zh: '牧草余量' },
  grassUsed: { en: 'Season budget used', zh: '牧季额度已用' },
  state_move: { en: 'Move stock off', zh: '需转场' },
  state_spent: { en: 'Rest it, do not graze again', zh: '本季不宜再放牧' },
  state_watch: { en: 'Plan the next move', zh: '准备转场' },
  state_ok: { en: 'Grazing, plenty left', zh: '放牧中，余量充足' },
  ...
  simpleFootnote: {
    en: 'Season budget is the grass a paddock can safely give up in one season. Past 100% it is being grazed harder than it can grow back.',
    zh: '牧季额度指该草场一个牧季可安全采食的牧草量。超过 100% 即采食速度快于再生速度。',
  },
